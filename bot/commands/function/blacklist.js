...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('blacklist')
    .setDescription('Blacklists a user from using the bot. [DEV ONLY]')
    ...
    if (interaction.user.id === '574783977223749632') {
      ...
      switch (result) {
        case "blacklisted":
          ...
          const blacklistedDMEmbed = new EmbedBuilder() //UNSURE
            .setColor('#f3786a')
        ...
        case "reactivated":
          embedToSend = new EmbedBuilder()
            ...
            .setColor(botColours.green)
            .setDescription(`${user.tag}'s blacklist has been reactivated with the updated reason.`)
            .addFields(
